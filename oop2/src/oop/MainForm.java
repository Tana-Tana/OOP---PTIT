...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        initComponents();
        setTitle("Quản lí phòng thực hành");
...
//            txtThongKe.setText("Thống kê tổng số máy tính theo từng phòng TH");
...
//        });
    ...
    private void initTable() {
        String[] headers = {"Ma", "Ten phong TH", "So may tinh","Loai phong"};
    ...
    private void initComponents() {
        ...
        btnLuuFile.setForeground(new java.awt.Color(51, 0, 51));
        ...
        cbSapXep.setForeground(new java.awt.Color(255, 255, 255));
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Số máy tính", "Loại phòng" }));
