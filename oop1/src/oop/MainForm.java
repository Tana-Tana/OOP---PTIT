...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        ...
        cbSapXep.addItemListener((ItemEvent e) -> {
            if (e.getStateChange() == ItemEvent.SELECTED) {
                ...
                if ("Tên môn".equals(selectedItem)) {
                    list.sort(Comparator.comparing(MonHoc::getTenMon));
                } else if ("Số tín chỉ".equals(selectedItem)) {
    ...
    private void initTable() {
        String[] headers = {"Ma mon", "Ten mon hoc", "So tin chi","Loai mon"};
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tên môn", "Số tín chỉ" }));
