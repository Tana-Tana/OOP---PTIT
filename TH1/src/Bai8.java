...
public class Bai8 {
    public static void main(String[] args) throws IOException {
        ...
        for(int i=1;i<=test;++i){
            ThiSinh x = new ThiSinh(bf.readLine(),bf.readLine(),Double.parseDouble(bf.readLine()),Double.parseDouble(bf.readLine()));
            x.Solve(i);
...
class ThiSinh {
    ...
    public int tong;
    public int tuoi;
    public ThiSinh(String ten, String ngaySinh, double lt, double th) {
        this.ten = ten;
