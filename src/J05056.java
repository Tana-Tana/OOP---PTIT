...
public class J05056 {
    public static void main(String[] args) throws ParseException {
        ...
        ArrayList<DongVien5056> arr = new ArrayList<>();
        TreeMap<Long, Integer> hm = new TreeMap<>();
        while (test-- > 0) {
            DongVien5056 x = new DongVien5056(sc.nextLine(), sc.nextLine(), sc.nextLine(), sc.nextLine());
            x.TinhToan();
        ...
        for (DongVien5056 x : arr) System.out.println(x);
    }
}

class DongVien5056 implements Comparable<DongVien5056> {
    public String hoTen;
    ...
    public DongVien5056(String hoTen, String ngaySinh, String thoiGianXuatPhat, String thoiGianDenDich) {
...
//        System.out.println(thanhTichThucTe);
    ...
    @Override
    public int compareTo(DongVien5056 o) {
        if (o.xepHang == xepHang) {
            if (o.tuoi > tuoi) return 1;
            return -1;

        } else {
            if (o.xepHang < xepHang) return 1;
            return -1;
        }
    }
